    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="repository" class="space-y-8">
        ...
        <div v-if="recentCommits.length > 0" class="card">
          ...
          <div class="space-y-4">
            <div v-for="commit in recentCommits.slice(0, 10)" :key="commit.id" class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
